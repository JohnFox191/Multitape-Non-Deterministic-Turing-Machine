...
public class TM_Run extends TM_Gui implements Runnable {
    ...
    public static String decisions_string = "", pLog = "";
    @Override
    public void run() {
    ...
    public static void draw(Execution execution) throws BadLocationException {
        int l = 0;
        // caso n esteja no mode run faster, atualizar os estados e o log a cada step
        if (!run_faster.isSelected()) {
            counterField.setText(String.valueOf(numpassos));
            paneTapesOutput.setText("");
            for (int j = 0; j < execution.tapes_with_content.size(); j++) {
            ...
            paneLog.setText(pLog);
        }
        // caso esteja no modo rápido só atualiza os estados a cada 50 steps
        else{
    ...
    public static void draw2(Execution execution) throws BadLocationException {
        int l = 0;
        counterField.setText(String.valueOf(numpassos));
        paneTapesOutput.setText("");
        for (int j = 0; j < execution.tapes_with_content.size(); j++) {
